<header class="banner sticky top-0 z-50 shadow-sm sm:static sm:shadow-none">
  <nav class="sticky bg-gray-100 text-gray-800" aria-label="{{ wp_get_nav_menu_name('primary_navigation') }}">
      ...
      <div class="relative flex h-16 items-center justify-between">
        <div class="absolute inset-y-0 left-0 flex items-center md:hidden">
          ...
          <button type="button" id="menuButton"
            class="inline-flex items-center justify-center rounded-md p-2 transition hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-1 focus:ring-inset focus:ring-gray-400"
            aria-controls="mobile-menu" aria-expanded="false">
            <span class="sr-only">Открыть главное меню</span>
            <svg class="block h-6 w-6" id="menuIcon" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
            <svg class="hidden h-6 w-6" id="menuCloseIcon" xmlns="http://www.w3.org/2000/svg" fill="none"
              viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <div class="flex flex-1 flex-shrink-0 items-center justify-center sm:justify-start lg:items-center">
          ...
          <div class="hidden flex-1 sm:ml-6 md:block">
            <div class="flex w-full space-x-2 lg:justify-start xl:space-x-4">
          ...
          <div class="ml-auto hidden grid-cols-5 justify-center gap-2 py-4 sm:grid md:space-x-1 lg:flex">
    ...
    <div class="hidden transition sm:hidden" id="mobile-menu">
      <div class="space-y-1 px-2 pt-2 pb-3">
        @if (has_nav_menu('primary_navigation'))
          ...
          @endforeach
        @endif
        <div class="flex w-full justify-between px-8 pt-4">
          <a href="https://www.facebook.com/sksosorg" class="text-gray-400 hover:text-gray-500">
            <span class="sr-only">Facebook</span>
            <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path fill-rule="evenodd"
