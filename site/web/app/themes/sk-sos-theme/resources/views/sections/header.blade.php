      ...
      <div class="relative flex h-16 items-center justify-between">
        <div class="absolute inset-y-0 left-0 flex items-center md:hidden">
          ...
          <button type="button" id="menuButton"
            class="inline-flex items-center justify-center rounded-md p-2 transition hover:bg-gray-700 hover:text-white focus:outline-none focus:ring-1 focus:ring-inset focus:ring-white"
